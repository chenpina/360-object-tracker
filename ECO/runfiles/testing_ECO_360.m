function results = testing_ECO_360(seq, res_path, bSaveImage, parameters)
...
params.min_image_sample_size = 300^2;   % Minimum area of image samples
params.max_image_sample_size = 400^2;   % Maximum area of image samples
...
params.scale_step = 1.04;               % The scale factor
...
% Initialize
params.init_sz = [seq.init_rect(1,3), seq.init_rect(1,4)];
% params.init_pos = [seq.init_rect(1,2), seq.init_rect(1,1)] + (params.init_sz - 1)/2;
params.init_pos = [seq.init_rect(1,1), seq.init_rect(1,2)]; % for 360
